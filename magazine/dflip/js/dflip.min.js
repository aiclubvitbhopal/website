...
var Dflip = () => {
  ...
  (function e(t, i) {
    ...
    var V = function (e, n) {
      ...
      var _ = (c.startPage = i(h.div, {
        class:
          r + " " + a + "-start " + (s ? u.icons["end"] : u.icons["start"]),
    ...
    function q() {
      ...
      var e = (function (e) {
        ...
        i.prototype.tween = function (e, i) {
          ...
          var u = function (e, t) {
            ...
            if (r) {
              n.material.materials[5].opacity =
                n.material.materials[4].opacity = e.index;
              n.castShadow =
          ...
          if (r && ((!l && !c) || (l && c))) {
            n.material.materials[5].opacity =
              n.material.materials[4].opacity = 0;
            n.castShadow = false;
          }
      ...
      var a = (function (e) {
        ...
        i.prototype.next = function (e) {
          if (e == null)
            e =
              this.direction == t.DIRECTION.RTL
                ? -this.pageMode
                : this.pageMode;
          this.moveBy(e);
        };
        ...
        i.prototype.updatePage = function (e) {
          ...
          for (var P = 0; P < c; P++) {
            ...
            if (i)
              E = a
                ? this.pageCount - E
                : Math.ceil(this.pageCount / 2) - E - 1;
      ...
      n.prototype = {
        ...
        resize: function () {
          ...
          if (h) {
            ...
            w =
              1 /
                ((2 * Math.tan((Math.PI * r.camera.fov * 0.5) / 180)) /
                  (J / P)) +
              2.2;
      ...
      function a(e, a, o, r) {
        ...
        if (
          ...
          for (var u = 0; u < s.contentSource.length; u++) {
            s.contentSource[u] = l.httpsCorrection(
              s.contentSource[u].toString()
            );
          }
          i("<img/>")
              ...
              o.promise.then(
                function e(i) {
                  ...
                  i.getPage(1).then(function (e) {
                    ...
                    s.zoomViewport = {
                      width:
                        (s.pageRatio > 1 ? 1 : s.pageRatio) * s.maxDimension,
                      height:
        ...
        tween: function (e) {
          ...
          if (i.isHard == true) {
            ...
            if (e == null) {
              ...
              g =
                (i.parent.duration * I(c.x, c.y, p.x, p.y)) /
                i.parent.fullWidth;
  ...
  DFLIP.Share = (function e(t) {
    function i(e, i) {
      ...
      n.urlInput = t('<textarea class="df-share-url">').on(
        "click",
        function () {
          t(this).select();
        }
